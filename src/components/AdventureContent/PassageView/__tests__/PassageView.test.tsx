...
describe("PassageView Component", () => {
  ...
  describe("Normal Passages", () => {
    ...
    it("renders choice buttons with passage ID prefix", () => {
      render(
        <PassageView
          passage={normalPassage}
          onChoiceClick={mockOnChoiceClick}
    ...
    it("renders notes when notes exist", () => {
      const passageWithNotes: Passage = {
        ...normalPassage,
        notes: "Test notes for content view",
      };
      ...
      expect(notes).toHaveTextContent("Test notes for content view");
    });
